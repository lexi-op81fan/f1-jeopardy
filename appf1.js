...
const jeopardyCategories = {
    {
        ...
        question: []
            {
                question: 'Who holds the records for the most Formula 1 starts?'
                answers: ['Lewis Hamilton', 'Fernando Alonso', 'Michael Schumaucher', 'Damon Hill']
                correct: 'Fernando Alonso'
                level: 'easy'
            },
            {
                question: 'Who holds the records for the most Formula 1 wins?'
                answers: ['Lewis Hamilton', 'Fernando Alonso', 'Michael Schumaucher', 'Damon Hill']
